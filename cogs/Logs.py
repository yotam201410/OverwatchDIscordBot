...
class Logs(commands.Cog):
    ...
    async def on_guild_channel_delete(self, channel: discord.abc.GuildChannel):
        if channel.guild.get_channel(get_audit_log_channel_id(channel.guild.id)) is not None:
            if channel.category is None:
                ...
                embed.add_field(name="date", value=f"{date}", inline=False)
            await channel.guild.get_channel(get_audit_log_channel_id(channel.guild.id)).send(embed=embed)
    ...
    async def on_guild_channel_update(self, before: discord.abc.GuildChannel, after: discord.abc.GuildChannel):
        if (before and before.guild.get_channel(get_audit_log_channel_id(before.guild.id)) is not None) or (after and after.guild.get_channel(get_audit_log_channel_id(after.guild.id)) is not None):
    ...
    async def on_member_join(self, member: discord.Member):
        if member.guild.get_channel(get_audit_log_channel_id(member.guild.id)) is not None:
            ...
            await member.guild.get_channel(get_audit_log_channel_id(member.guild.id)).send(embed=embed)
    ...
    async def on_member_update(self, before: discord.Member, after: discord.Member):
        if before.guild.get_channel(get_audit_log_channel_id(before.guild.id)) is not None:

            audit_log_channel = before.guild.get_channel(get_audit_log_channel_id(before.guild.id))
    ...
    async def on_guild_role_create(self, role: discord.Role):
        if role.guild.get_channel(get_audit_log_channel_id(role.guild.id)) is not None:
            ...
            embed.add_field(name="ID", value=f"````py\n Role = {role.id}")
            await role.guild.get_channel(get_audit_log_channel_id(role.guild.id)).send(embed=embed)
    ...
    async def on_guild_role_update(self, before: discord.Role, after: discord.Role):
        ...
        """
        if after.guild.get_channel(get_audit_log_channel_id(after.guild.id)) is not None:
            ...
            embed.add_field(name="ID", value=f"````py\n Role = {after.id}")
            await after.guild.get_channel(get_audit_log_channel_id(after.guild.id)).send(embed=embed)
    ...
    async def on_voice_state_update(self, member: discord.Member, before: discord.VoiceState,
        ...
        if member.guild.get_channel(get_audit_log_channel_id(member.guild.id)) is not None:
            date = datetime.datetime.utcnow()
            audit_log_channel = member.guild.get_channel(get_audit_log_channel_id(member.guild.id))
    ...
    async def on_member_ban(self, guild: discord.Guild, user: discord.User):
        if guild.get_channel(get_audit_log_channel_id(guild.id)) is not None:
            date = datetime.datetime.utcnow()
            audit_log_channel = guild.get_channel(get_audit_log_channel_id(guild.id))
